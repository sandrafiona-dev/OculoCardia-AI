        ...
        <>
            ...
            >
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem' }}>Diagnostic AI Engine v3.0 | Non-diagnostic AI-assisted decision-support tool</p>
                </div>
                            ...
                            {prediction && (
                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginBottom: '1rem' }}>
                                        ...
                                        <button className="btn-action" onClick={() => navigate('/prevention', { state: { prediction } })} disabled={!prediction} style={{ flex: 1, maxWidth: '300px', background: 'rgba(0, 242, 254, 0.1)', color: 'var(--accent-primary)', border: '1px solid var(--accent-primary)' }}>
                                            <ShieldCheck size={20} />
